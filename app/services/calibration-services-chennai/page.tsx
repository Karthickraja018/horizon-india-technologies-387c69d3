...
const calibrationRows = [
  { equipment: "Hardness Testers", standard: "ASTM E18 / IS 1586", certificate: "NABL Certificate", turnaround: "24-48 hrs" },
  { equipment: "Universal Testing Machine (UTM)", standard: "ASTM E4", certificate: "NABL Certificate", turnaround: "48-72 hrs" },
  { equipment: "Impact Testing Machines", standard: "ASTM E23 / IS 1757", certificate: "NABL Certificate", turnaround: "48-72 hrs" },
  { equipment: "Metrology Instruments", standard: "ISO 17025 Traceable Methods", certificate: "NABL Certificate", turnaround: "24-72 hrs" },
  { equipment: "NDT Instruments", standard: "Applicable ASTM / ISO Methods", certificate: "NABL Certificate", turnaround: "48-96 hrs" },
];
    ...
    <div className="bg-background min-h-screen">
      <div className="container mx-auto px-6 lg:px-12 py-16">
        <div className="mb-5 text-sm text-hero-muted">
          ...
          <Link href="/services" className="hover:text-hero-accent transition-colors">Services</Link>
          <span className="mx-2">/</span>
        ...
        <section className="mb-14">
          ...
          <p className="text-hero-muted max-w-4xl leading-relaxed">
            Calibration is the documented process of validating instrument accuracy against traceable
            standards. It is essential for consistent quality control, statutory compliance, and
            audit readiness under ISO 9001, IATF 16949, and NABL requirements. Our team provides
            fast, traceable, and accredited calibration support across Chennai and Tamil Nadu.
          </p>
        </section>

        <section className="mb-14">
          <span className="label-eyebrow">Scope of Calibration</span>
          <h2 className="text-2xl font-bold text-hero-headline mt-2 mb-5">
            Coverage, Standards & Turnaround
          </h2>
        ...
        <section className="mb-14">
          ...
          <h2 className="text-2xl font-bold text-hero-headline mt-2 mb-4">
            Accepted Witnessing Bodies
          </h2>
          <p className="text-hero-muted mb-4 max-w-3xl">
            We can support calibration programs with third-party witnessing where project or customer
            requirements apply.
          </p>
          <div className="flex flex-wrap gap-2">
            {witnessBodies.map((body) => (
              <span key={body} className="tag-chip">{body}</span>
            ))}
          </div>
        </section>
        ...
        <section className="grid lg:grid-cols-12 gap-8">
            ...
            {submitted ? (
              <div className="rounded-md border border-border bg-background p-4">
                ...
                <p className="text-hero-muted text-sm mt-1">
                  Our calibration team will contact you for slot confirmation.
                </p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block text-hero-muted text-xs uppercase tracking-wider font-semibold mb-1.5">
                    Equipment Name
                  </label>
                  <input
                    type="text"
          ...
          <aside className="lg:col-span-5 surface-card p-6 lg:p-8 h-fit">
            ...
            <p className="text-hero-muted text-sm mb-5">
              Download our NABL scope certificate directly for vendor qualification and audit
              documentation.
            </p>
            ...
            <div className="mt-6 pt-5 border-t border-border text-sm text-hero-muted space-y-2">
              <p className="inline-flex items-start gap-2">
                <ShieldCheck className="w-4 h-4 mt-0.5 text-hero-accent" /> ISO/IEC 17025 aligned
                workflows
              </p>
              <p className="inline-flex items-start gap-2">
                <ShieldCheck className="w-4 h-4 mt-0.5 text-hero-accent" /> Chennai and Tamil Nadu
                coverage
              </p>
              <p className="inline-flex items-start gap-2">
                <ShieldCheck className="w-4 h-4 mt-0.5 text-hero-accent" /> Same-day scheduling
                options
              </p>
            </div>
          </aside>

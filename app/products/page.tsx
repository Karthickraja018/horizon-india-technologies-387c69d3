              ...
              >
                <div className="flex items-start gap-4 mb-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <h2 className="text-hero-headline font-semibold text-base mb-1 group-hover:text-hero-accent transition-colors">
                      {cat.name}
                    </h2>
                    <p className="text-hero-muted text-xs leading-relaxed line-clamp-2">
                      {cat.description}
                    </p>
                  </div>
                </div>
                <div className="mt-auto pt-3 border-t border-border flex items-center justify-between">
                  <span className="text-hero-muted text-[10px] uppercase tracking-wider">

        ...
        <div className="-mx-6 lg:-mx-12 px-6 lg:px-12 overflow-x-auto scroll-smooth snap-x snap-mandatory pb-4 [scrollbar-width:thin]">
          <div className="flex gap-4 min-w-max">
            {featuredCategories.map((cat) => (
              ...
              >
                ...
                <div className="p-4 flex flex-col flex-1">
                  ...
                  <p className="text-hero-muted text-xs leading-relaxed line-clamp-2 flex-1">{cat.description}</p>
            ...
            >
              ...
              <p className="text-hero-muted text-xs">10 product categories · 50+ models</p>

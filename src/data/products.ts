...
export const products: Product[] = [
  // Hardness Testing
  {
    ...
    image: "/placeholder.svg", description: "High-precision digital Rockwell hardness tester with automatic load application and result display.",
  ...
  },
  {
    ...
    image: "/placeholder.svg", description: "Robust Brinell hardness tester for heavy-duty applications with optical measurement system.",
  ...
  },
  {
    ...
    image: "/placeholder.svg", description: "Precision Vickers/Knoop micro-hardness tester with digital imaging and auto-indent measurement.",
  ...
  // Universal Testing Machines
  {
    ...
    image: "/placeholder.svg", description: "Versatile electromechanical universal testing machine for tensile, compression, and flexure testing.",
  ...
  },
  {
    ...
    image: "/placeholder.svg", description: "High-capacity servo-hydraulic UTM for heavy-duty material testing applications.",
  ...
  // Sand Testing
  {
    ...
    image: "/placeholder.svg", description: "Multi-purpose sand strength testing machine for foundry quality control.",
  ...
  // Metrology
  {
    ...
    image: "/placeholder.svg", description: "High-precision digital height gauge with carbide-tipped scribers.",
  ...
  // NDT Equipment
  {
    ...
    image: "/placeholder.svg", description: "Portable digital ultrasonic flaw detector with full A-scan display.",
  ...
  // Impact Testing
  {
    ...
    image: "/placeholder.svg", description: "Pendulum-type Charpy impact tester with digital energy measurement and temperature chamber.",
  ...
  // Civil Lab
  {
    ...
    image: "/placeholder.svg", description: "Digital compression testing machine for concrete cubes and cylinders.",
  ...
  // Microscopes
  {
    ...
    image: "/placeholder.svg", description: "Research-grade inverted metallurgical microscope with trinocular head and image analysis.",
  ...
  // Sample Preparation
  {
    ...
    image: "/placeholder.svg", description: "Heavy-duty abrasive cutter for metallographic sample sectioning.",
  ...
  // Profile Projector
  {
    ...
    image: "/placeholder.svg", description: "Floor-standing profile projector with digital readout and edge detection.",
